...
```
**Retired — must not appear anywhere in code, queries, or UI switch statements:**
...
### Size Cap Contract
- Waist ≥ 33" or women's numeric size ≥ 18 → automatically return `smart_estimate` with disclaimer. Either condition alone triggers it.
