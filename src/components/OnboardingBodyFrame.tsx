  ...
  return (
    <>
      ...
      <CardFooter className="bg-card p-6 sm:p-8 border-t-4 border-border">
        <Button
          className={`w-full border-2 font-black text-xl py-8 transition-all ${selected !== null ? 'bg-primary text-primary-foreground border-border shadow-hard shadow-hard-hover shadow-hard-active cursor-pointer' : 'bg-muted text-muted-foreground border-border/40 shadow-[1px_1px_0px_0px_var(--border)] cursor-not-allowed'}`}
