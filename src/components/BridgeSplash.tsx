...
export function BridgeSplash() {
  ...
  return (
    <div className="min-h-screen w-screen flex items-center justify-center bg-background p-4">
      ...
      <Card className="w-full max-w-lg mx-auto border-2 border-border shadow-hard bg-card rounded-2xl overflow-hidden flex flex-col">
      {/* Amber Header */}
      <div className="w-full bg-primary border-b-2 border-border px-6 py-5">
