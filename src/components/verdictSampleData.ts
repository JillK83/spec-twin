...
export const estimatePillars: Pillar[] = [
  {
    ...
    detail: 'Your Madewell has significant stretch. This item has none — it will feel noticeably more structured and may fit very differently through the waist and hip. Check the brand\'s size guide before buying.',
  },
  {
    id: 'waist-hip',
    name: 'Waist and Hip Fit',
